              ...
              {currentProducts.length > 0 ? (
                currentProducts.map((p) => (
                  <tr key={p.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="text-sm text-gray-900 capitalize">{p.category}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="text-sm font-medium text-gray-900">₹{p.price.toLocaleString()}</div>
                    </td>
                    <td className="px-6 py-4">
                      <div className={`text-sm font-medium ${p.count < 10 ? 'text-red-600' : 'text-gray-900'}`}>
                        {p.count} {p.count < 10 && <span className="text-xs text-red-500">(Low stock)</span>}
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <button 
