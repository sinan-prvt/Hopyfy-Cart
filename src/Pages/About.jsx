            ...
            <div className="md:w-1/2">
              <div className="h-full w-full bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center p-8">
                <div className="bg-white bg-opacity-20 backdrop-blur-lg rounded-2xl p-6 w-full max-w-md">
                  <img src={"./about.png"} className="aspect-square bg-gray-200 border-2 border-dashed rounded-xl w-full" />
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-indigo-50 transform transition-transform duration-300 hover:-translate-y-2">
            <div className="bg-indigo-100 w-16 h-16 rounded-full flex items-center justify-center mb-6">
              <img src={"./Icons/achievement.png"} className="text-indigo-700 text-2xl h-12"/> 
            </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-indigo-50 transform transition-transform duration-300 hover:-translate-y-2">
            <div className="bg-indigo-100 w-16 h-16 rounded-full flex items-center justify-center mb-6">
              <img src={"./Icons/rating.png"} className="text-indigo-700 text-2xl h-11"/> 
            </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-indigo-50 transform transition-transform duration-300 hover:-translate-y-2">
            <div className="bg-indigo-100 w-16 h-16 rounded-full flex items-center justify-center mb-6">
              <img src={"./Icons/sus.png"} className="text-indigo-700 text-2xl h-12"/> 
            </div>
  ...
  <div className="bg-white rounded-3xl shadow-xl p-12 text-center">
    ...
    <div className="flex justify-center space-x-6">
      {[
        ...
        >
          <div className="w-16 h-16 rounded-full bg-indigo-100 flex items-center justify-center mb-2 group-hover:bg-indigo-200 transition-colors overflow-hidden">
            <img 
              src={platform.img} 
              alt={platform.label}
          ...
          <span className="text-indigo-700 font-medium group-hover:text-indigo-900">
            {platform.label}
          </span>
        </a>
      ))}
